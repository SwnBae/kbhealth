...
class DietTest {
    ...
    void 식단_기록_조회() {
        ...
        recordService.saveDietRecord(new DietRecordRequest(dietId1, 500, null, MealType.BREAKFAST), savedMemberId);
        recordService.saveDietRecord(new DietRecordRequest(dietId2, 600, null, MealType.DINNER), savedMemberId);
    ...
    void 식단_기록_수정() {
        ...
        DietRecordRequest updateRequest = new DietRecordRequest(dietId2, 600, null, MealType.DINNER);
    ...
    void 식단_기록_삭제() {
        ...
        recordService.saveDietRecord(new DietRecordRequest(dietId, 600, null, MealType.LUNCH), savedMemberId);
