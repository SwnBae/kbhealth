...
public class GptService {
    ...
    private String createHealthCheckPrompt(GptHealthCheckRequest request) {
        ...
        prompt.append("또한, 우리의 앱 이름은 HealthComfit이야, 운동기록, 식단기록을 기록하고, 사용자들과 채팅,게시글,댓글,좋아요 등으로 소통할 수 있어. 기록을 바탕으로 점수를 매기고, 랭킹도 매겨주지.\n\n");
    ...
    private String buildPrompt(GptFoodRecommendRequest req) {
        ...
        또한, 우리의 앱 이름은 HealthComfit이야, 운동기록, 식단기록을 기록하고, 사용자들과 채팅,게시글,댓글,좋아요 등으로 소통할 수 있어. 기록을 바탕으로 점수를 매기고, 랭킹도 매겨주지.
